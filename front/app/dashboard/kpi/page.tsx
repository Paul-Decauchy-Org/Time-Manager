...
export default function KpiIndexPage() {
  ...
  return React.createElement(
    ...
    React.createElement(
      "a",
      {
        href: "/dashboard/kpi/user",
        className:
          "block rounded-xl border p-6 shadow-sm hover:shadow-md transition",
      },
      React.createElement(
        "div",
      ...
      React.createElement(
        ...
        "Vos heures, ponctualite, presence",
      ),
    ),
    React.createElement(
      "a",
      ...
      React.createElement(
        "div",
        { className: "text-muted-foreground text-sm" },
        "Vue manager: charge et couverture",
      ),
    ),
    React.createElement(
      "a",
      {
        href: "/dashboard/kpi/admin",
        className:
          "block rounded-xl border p-6 shadow-sm hover:shadow-md transition",
      },
      React.createElement(
      ...
      React.createElement(
        "div",
        { className: "text-muted-foreground text-sm" },
        "Vue globale: utilisateurs et equipes",
      ),
    ),
  );
}
