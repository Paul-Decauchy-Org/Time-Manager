            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-muted-foreground text-balance">
                  Login to your Time Manager account
                </p>
              </div>
              <Field>
              ...
              {error?.message && <div className="text-sm text-red-500 mt-2 px-6">{error.message}</div>}
              ...
              {/*  </Button>*/}
              {/*</Field>*/}
              <FieldDescription className="text-center">Don&apos;t have an account? <SignupLink /></FieldDescription>
            </FieldGroup>
          </form>
