...
type QueryResolver interface {
	...
	GetUsersInTeam(ctx context.Context, teamID string) ([]*model.User, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.getUsersInTeam":
		if e.complexity.Query.GetUsersInTeam == nil {
			break
		}

		args, err := ec.field_Query_getUsersInTeam_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.GetUsersInTeam(childComplexity, args["teamID"].(string)), true
	case "Query.me":
...
func (ec *executionContext) _Query_getUsersInTeam(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		ec.fieldContext_Query_getUsersInTeam,
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.resolvers.Query().GetUsersInTeam(ctx, fc.Args["teamID"].(string))
		},
		nil,
		ec.marshalNUser2ᚕᚖgithubᚗcomᚋepitechᚋtimemanagerᚋinternalᚋgraphᚋmodelᚐUserᚄ,
		true,
...
func (ec *executionContext) fieldContext_Query_getUsersInTeam(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_getUsersInTeam_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
	...
	for i, field := range fields {
		...
		case "getUsersInTeam":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_getUsersInTeam(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
